...
```
D:\Projects\codes\MATLAB_in_c\release\v1.2.43\matlab.bat
```
...
- Known bugs in the MATLAB clone (v1.2.37, fixed across v1.2.38-v1.2.43) are
  tracked in
  [docs/2026-08-10-matlab-clone-bug-report.md](docs/2026-08-10-matlab-clone-bug-report.md);
  the port targets v1.2.43, follows real MATLAB semantics, and avoids the
